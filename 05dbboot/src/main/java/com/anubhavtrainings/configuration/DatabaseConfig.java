...
public class DatabaseConfig extends AbstractCloudConfig {
	...
	@Value("${vcap.services.postgresql.credentials.password}")
	private String password;
	
	@Value("${vcap.services.postgresql.credentials.url}")
	private String hostname;
	
	@Value("${vcap.services.postgresql.credentials.port}")
	private String port;
	
	@Value("${vcap.services.postgresql.credentials.schema}")
